...
class EmployeePermitController extends Controller
{
    ...
    public function __construct(EmployeePermitService $service)
    {
     ...
     */
    public function store(CreateEmployeePermitRequest $request)
    {
     ...
     */
    public function update(UpdateEmployeePermitRequest $request, $id)
    {
