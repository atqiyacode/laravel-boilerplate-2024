...
class EmployeeAchievementController extends Controller
{
    ...
    public function __construct(EmployeeAchievementService $service)
    {
     ...
     */
    public function store(CreateEmployeeAchievementRequest $request)
    {
     ...
     */
    public function update(UpdateEmployeeAchievementRequest $request, $id)
    {
