...
class EmployeeRelationReferenceController extends Controller
{
    ...
    public function __construct(EmployeeRelationReferenceService $service)
    {
     ...
     */
    public function store(CreateEmployeeRelationReferenceRequest $request)
    {
     ...
     */
    public function update(UpdateEmployeeRelationReferenceRequest $request, $id)
    {
