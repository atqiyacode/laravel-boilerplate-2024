...
class EmployeePermitRemainingController extends Controller
{
    ...
    public function __construct(EmployeePermitRemainingService $service)
    {
     ...
     */
    public function store(CreateEmployeePermitRemainingRequest $request)
    {
        $request->merge([
            'total' => $request->limit - $request->has_use
        ]);
     ...
     */
    public function update(UpdateEmployeePermitRemainingRequest $request, $id)
    {
        $request->merge([
            'total' => $request->limit - $request->has_use
        ]);
