...
class EmployeeAttachmentController extends Controller
{
    ...
    public function __construct(EmployeeAttachmentService $service)
    {
     ...
     */
    public function store(CreateEmployeeAttachmentRequest $request)
    {
     ...
     */
    public function update(UpdateEmployeeAttachmentRequest $request, $id)
    {
