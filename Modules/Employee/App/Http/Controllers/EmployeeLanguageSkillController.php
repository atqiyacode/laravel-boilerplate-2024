...
class EmployeeLanguageSkillController extends Controller
{
    ...
    public function __construct(EmployeeLanguageSkillService $service)
    {
     ...
     */
    public function store(CreateEmployeeLanguageSkillRequest $request)
    {
     ...
     */
    public function update(UpdateEmployeeLanguageSkillRequest $request, $id)
    {
