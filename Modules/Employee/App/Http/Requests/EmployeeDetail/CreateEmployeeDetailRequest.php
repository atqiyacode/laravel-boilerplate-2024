...
namespace Modules\Employee\App\Http\Requests\EmployeeDetail;

use Illuminate\Foundation\Http\FormRequest;

class CreateEmployeeDetailRequest extends FormRequest
{
    public function rules(): array
    {
        return [

            'id_card' => ['required', 'unique:employee_details,id_card'],
            'employee_id' => ['required', 'exists:employees,id', 'unique:employee_details,employee_id'],
            'npwp' => ['required', 'unique:employee_details,npwp'],
            'account_number' => ['required', 'unique:employee_details,account_number'],
            ...
            'tanggal_efektif_berhenti_kerja' => ['nullable', 'date', 'after_or_equal:tanggal_pengajuan_surat_resign'],
