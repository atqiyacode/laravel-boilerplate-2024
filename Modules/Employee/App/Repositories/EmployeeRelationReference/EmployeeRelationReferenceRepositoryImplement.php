...
namespace Modules\Employee\App\Repositories\EmployeeRelationReference;
...
class EmployeeRelationReferenceRepositoryImplement extends Eloquent implements EmployeeRelationReferenceRepository
{
    ...
    public function __construct(EmployeeRelationReference $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->with(['employee'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['employee'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->with(['employee'])->useFilters()->findOrFail($id);
    }
