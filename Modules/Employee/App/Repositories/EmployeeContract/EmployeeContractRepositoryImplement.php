...
namespace Modules\Employee\App\Repositories\EmployeeContract;
...
class EmployeeContractRepositoryImplement extends Eloquent implements EmployeeContractRepository
{
    ...
    {
        return $this->model->canDelete()->with(['employee', 'project'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['employee', 'project'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->with(['employee', 'project'])->useFilters()->findOrFail($id);
    }
