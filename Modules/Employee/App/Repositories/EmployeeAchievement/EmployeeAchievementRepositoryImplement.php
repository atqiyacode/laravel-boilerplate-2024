...
class EmployeeAchievementRepositoryImplement extends Eloquent implements EmployeeAchievementRepository
{
    ...
    public function __construct(EmployeeAchievement $model)
    {
        $this->model = $model;
    }
