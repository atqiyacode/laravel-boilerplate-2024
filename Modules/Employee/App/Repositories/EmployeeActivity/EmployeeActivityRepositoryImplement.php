...
namespace Modules\Employee\App\Repositories\EmployeeActivity;
...
class EmployeeActivityRepositoryImplement extends Eloquent implements EmployeeActivityRepository
{
    ...
    public function __construct(EmployeeActivity $model)
    {
        $this->model = $model;
    }
    ...
    public function getPaginate()
    {
        return $this->model->with([
            'employee',
            'typeOfActivity'
        ])->canDelete()->useFilters()->dynamicPaginate();
    }
    ...
    public function findById($id)
    {
        return $this->model->with([
            'employee',
            'typeOfActivity'
        ])->canDelete()->useFilters()->findOrFail($id);
    }
