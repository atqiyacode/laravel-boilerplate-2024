...
class EmployeeLanguageSkillRepositoryImplement extends Eloquent implements EmployeeLanguageSkillRepository
{
    ...
    public function __construct(EmployeeLanguageSkill $model)
    {
        $this->model = $model;
    }
