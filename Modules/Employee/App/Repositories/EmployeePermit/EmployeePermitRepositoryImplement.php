...
namespace Modules\Employee\App\Repositories\EmployeePermit;
...
class EmployeePermitRepositoryImplement extends Eloquent implements EmployeePermitRepository
{
    ...
    public function __construct(EmployeePermit $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->with(['employee', 'typeOfPermit', 'permitStatus'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['employee', 'typeOfPermit', 'permitStatus'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->with(['employee', 'typeOfPermit', 'permitStatus'])->useFilters()->findOrFail($id);
    }
