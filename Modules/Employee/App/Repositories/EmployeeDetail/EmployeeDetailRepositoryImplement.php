...
namespace Modules\Employee\App\Repositories\EmployeeDetail;
...
class EmployeeDetailRepositoryImplement extends Eloquent implements EmployeeDetailRepository
{
    ...
    public function __construct(EmployeeDetail $model)
    {
        $this->model = $model;
    }
