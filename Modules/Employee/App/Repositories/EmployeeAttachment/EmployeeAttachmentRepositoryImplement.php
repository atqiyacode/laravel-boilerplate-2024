...
class EmployeeAttachmentRepositoryImplement extends Eloquent implements EmployeeAttachmentRepository
{
    ...
    public function __construct(EmployeeAttachment $model)
    {
        $this->model = $model;
    }
