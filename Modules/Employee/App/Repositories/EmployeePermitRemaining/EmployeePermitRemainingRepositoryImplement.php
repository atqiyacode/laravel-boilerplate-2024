...
class EmployeePermitRemainingRepositoryImplement extends Eloquent implements EmployeePermitRemainingRepository
{
    ...
    public function __construct(EmployeePermitRemaining $model)
    {
        $this->model = $model;
    }
