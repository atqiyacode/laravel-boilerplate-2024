...
class EmployeeMediaSocialRepositoryImplement extends Eloquent implements EmployeeMediaSocialRepository
{
    ...
    public function __construct(EmployeeMediaSocial $model)
    {
        $this->model = $model;
    }
