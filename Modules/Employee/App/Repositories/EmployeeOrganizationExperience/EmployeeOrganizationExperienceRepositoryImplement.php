...
class EmployeeOrganizationExperienceRepositoryImplement extends Eloquent implements EmployeeOrganizationExperienceRepository
{
    ...
    public function __construct(EmployeeOrganizationExperience $model)
    {
        $this->model = $model;
    }
