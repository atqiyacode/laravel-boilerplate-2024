...
class EmployeeAchievementServiceImplement extends ServiceApi implements EmployeeAchievementService
{
    ...
    public function __construct(EmployeeAchievementRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeAchievementResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeAchievementResource($response));
    }
