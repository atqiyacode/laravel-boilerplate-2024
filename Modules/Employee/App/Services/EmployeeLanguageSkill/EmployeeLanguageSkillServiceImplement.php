...
class EmployeeLanguageSkillServiceImplement extends ServiceApi implements EmployeeLanguageSkillService
{
    ...
    public function __construct(EmployeeLanguageSkillRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeLanguageSkillResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeLanguageSkillResource($response));
    }
