...
class EmployeePermitRemainingServiceImplement extends ServiceApi implements EmployeePermitRemainingService
{
    ...
    public function __construct(EmployeePermitRemainingRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeePermitRemainingResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeePermitRemainingResource($response));
    }
