...
class EmployeeMediaSocialServiceImplement extends ServiceApi implements EmployeeMediaSocialService
{
    ...
    public function __construct(EmployeeMediaSocialRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeMediaSocialResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeMediaSocialResource($response));
    }
