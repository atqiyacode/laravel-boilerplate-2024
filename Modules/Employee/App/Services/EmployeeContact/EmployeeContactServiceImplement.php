...
use Modules\Employee\App\Repositories\EmployeeContact\EmployeeContactRepository;

class EmployeeContactServiceImplement extends ServiceApi implements EmployeeContactService
{
    ...
    public function __construct(EmployeeContactRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeContactResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeContactResource($response));
    }
