...
class EmployeeEmergencyContactServiceImplement extends ServiceApi implements EmployeeEmergencyContactService
{
    ...
    public function __construct(EmployeeEmergencyContactRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeEmergencyContactResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeEmergencyContactResource($response));
    }
