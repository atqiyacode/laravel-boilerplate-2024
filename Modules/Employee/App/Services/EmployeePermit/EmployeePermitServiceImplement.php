...
use Modules\Employee\App\Http\Resources\EmployeePermit\EmployeePermitResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Employee\App\Repositories\EmployeePermit\EmployeePermitRepository;

class EmployeePermitServiceImplement extends ServiceApi implements EmployeePermitService
{
    ...
    public function __construct(EmployeePermitRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeePermitResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeePermitResource($response));
    }
