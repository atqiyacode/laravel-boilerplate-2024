...
class EmployeeOrganizationExperienceServiceImplement extends ServiceApi implements EmployeeOrganizationExperienceService
{
    ...
    public function __construct(EmployeeOrganizationExperienceRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeOrganizationExperienceResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeOrganizationExperienceResource($response));
    }
