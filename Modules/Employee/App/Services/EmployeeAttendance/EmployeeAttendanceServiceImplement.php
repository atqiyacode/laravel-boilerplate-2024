...
class EmployeeAttendanceServiceImplement extends ServiceApi implements EmployeeAttendanceService
{
    ...
    public function __construct(EmployeeAttendanceRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeAttendanceResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeAttendanceResource($response));
    }
