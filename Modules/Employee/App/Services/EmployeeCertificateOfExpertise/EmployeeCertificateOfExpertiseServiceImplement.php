...
class EmployeeCertificateOfExpertiseServiceImplement extends ServiceApi implements EmployeeCertificateOfExpertiseService
{
    ...
    public function __construct(EmployeeCertificateOfExpertiseRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeCertificateOfExpertiseResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeCertificateOfExpertiseResource($response));
    }
