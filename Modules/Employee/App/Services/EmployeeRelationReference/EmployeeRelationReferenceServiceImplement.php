...
class EmployeeRelationReferenceServiceImplement extends ServiceApi implements EmployeeRelationReferenceService
{
    ...
    public function __construct(EmployeeRelationReferenceRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeeRelationReferenceResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeeRelationReferenceResource($response));
    }
