...
class EmployeePermitStructureServiceImplement extends ServiceApi implements EmployeePermitStructureService
{
    ...
    public function __construct(EmployeePermitStructureRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(EmployeePermitStructureResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new EmployeePermitStructureResource($response));
    }
