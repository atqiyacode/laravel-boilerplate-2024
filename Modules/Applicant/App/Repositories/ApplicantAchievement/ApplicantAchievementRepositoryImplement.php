...
namespace Modules\Applicant\App\Repositories\ApplicantAchievement;
...
class ApplicantAchievementRepositoryImplement extends Eloquent implements ApplicantAchievementRepository
{
    ...
    public function __construct(ApplicantAchievement $model)
    {
        $this->model = $model;
    }
