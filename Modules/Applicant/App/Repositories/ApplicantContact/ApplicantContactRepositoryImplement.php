...
class ApplicantContactRepositoryImplement extends Eloquent implements ApplicantContactRepository
{
    ...
    public function __construct(ApplicantContact $model)
    {
        $this->model = $model;
    }
    ...
    {
        $query = $this->model->canDelete()->useFilters()->findOrFail($id);
        $query->update($data);
        return $query;
    }
    ...
    {
        $query = $this->model->useFilters()->findOrFail($id)->delete();
        return $query;
    }
