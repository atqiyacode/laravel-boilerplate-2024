...
class ApplicantOrganizationExperienceRepositoryImplement extends Eloquent implements ApplicantOrganizationExperienceRepository
{
    ...
    public function __construct(ApplicantOrganizationExperience $model)
    {
        $this->model = $model;
    }
