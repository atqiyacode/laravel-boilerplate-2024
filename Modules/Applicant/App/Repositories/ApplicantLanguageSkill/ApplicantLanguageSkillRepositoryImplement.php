...
namespace Modules\Applicant\App\Repositories\ApplicantLanguageSkill;
...
class ApplicantLanguageSkillRepositoryImplement extends Eloquent implements ApplicantLanguageSkillRepository
{
    ...
    public function __construct(ApplicantLanguageSkill $model)
    {
        $this->model = $model;
    }
