...
namespace Modules\Applicant\App\Repositories\ApplicantEmergencyContact;
...
class ApplicantEmergencyContactRepositoryImplement extends Eloquent implements ApplicantEmergencyContactRepository
{
    ...
    public function __construct(ApplicantEmergencyContact $model)
    {
        $this->model = $model;
    }
