...
namespace Modules\Applicant\App\Repositories\ApplicantEducation;
...
class ApplicantEducationRepositoryImplement extends Eloquent implements ApplicantEducationRepository
{
    ...
    public function __construct(ApplicantEducation $model)
    {
        $this->model = $model;
    }
