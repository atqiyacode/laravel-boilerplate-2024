...
namespace Modules\Applicant\App\Repositories\ApplicantAttachment;
...
class ApplicantAttachmentRepositoryImplement extends Eloquent implements ApplicantAttachmentRepository
{
    ...
    public function __construct(ApplicantAttachment $model)
    {
        $this->model = $model;
    }
