...
namespace Modules\Applicant\App\Repositories\ApplicantRelationReference;
...
class ApplicantRelationReferenceRepositoryImplement extends Eloquent implements ApplicantRelationReferenceRepository
{
    ...
    public function __construct(ApplicantRelationReference $model)
    {
        $this->model = $model;
    }
