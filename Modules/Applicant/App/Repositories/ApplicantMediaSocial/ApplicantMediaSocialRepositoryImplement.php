...
namespace Modules\Applicant\App\Repositories\ApplicantMediaSocial;
...
class ApplicantMediaSocialRepositoryImplement extends Eloquent implements ApplicantMediaSocialRepository
{
    ...
    public function __construct(ApplicantMediaSocial $model)
    {
        $this->model = $model;
    }
