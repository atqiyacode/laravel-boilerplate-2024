...
namespace Modules\Applicant\App\Repositories\ApplicantCertificateOfExpertise;
...
class ApplicantCertificateOfExpertiseRepositoryImplement extends Eloquent implements ApplicantCertificateOfExpertiseRepository
{
    ...
    public function __construct(ApplicantCertificateOfExpertise $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->with(['applicantResume'])->canDelete()->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->with(['applicantResume'])->canDelete()->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->with(['applicantResume'])->canDelete()->useFilters()->findOrFail($id);
    }
