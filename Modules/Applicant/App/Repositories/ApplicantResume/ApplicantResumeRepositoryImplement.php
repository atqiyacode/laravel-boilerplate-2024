...
namespace Modules\Applicant\App\Repositories\ApplicantResume;
...
class ApplicantResumeRepositoryImplement extends Eloquent implements ApplicantResumeRepository
{
    ...
    public function __construct(ApplicantResume $model)
    {
        $this->model = $model;
    }
    ...
    public function findByUserId($userId)
    {
        return $this->model->canDelete()->with([
            ...
            ->useFilters()->whereUserId($userId)->first();
    }
