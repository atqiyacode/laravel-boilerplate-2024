...
namespace Modules\Applicant\App\Repositories\ApplicantExperience;
...
class ApplicantExperienceRepositoryImplement extends Eloquent implements ApplicantExperienceRepository
{
    ...
    public function __construct(ApplicantExperience $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->with(['applicantResume', 'levelOfEducation'])->canDelete()->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->with(['applicantResume', 'levelOfEducation'])->canDelete()->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->with(['applicantResume', 'levelOfEducation'])->canDelete()->useFilters()->findOrFail($id);
    }
