...
class CreateApplicantAttachmentRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            'applicant_resume_id' => ['required', 'exists:applicant_resumes,id', 'unique:applicant_attachments,applicant_resume_id'],
