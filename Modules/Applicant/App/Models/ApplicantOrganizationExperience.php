...
use Modules\Applicant\App\Filters\ApplicantOrganizationExperienceFilters;
...
class ApplicantOrganizationExperience extends Model
{
    use HasFactory, Loggable, Filterable, SoftDeletes, CanDeleteScope, DeveloperScope;

    protected string $default_filters = ApplicantOrganizationExperienceFilters::class;
