...
namespace Modules\Applicant\App\Services\ApplicantCertificateOfExpertise;

use Modules\Applicant\App\Http\Resources\ApplicantCertificateOfExpertise\ApplicantCertificateOfExpertiseResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantCertificateOfExpertise\ApplicantCertificateOfExpertiseRepository;

class ApplicantCertificateOfExpertiseServiceImplement extends ServiceApi implements ApplicantCertificateOfExpertiseService
{
    ...
    public function __construct(ApplicantCertificateOfExpertiseRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantCertificateOfExpertiseResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantCertificateOfExpertiseResource($response));
    }
