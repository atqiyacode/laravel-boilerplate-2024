...
namespace Modules\Applicant\App\Services\ApplicantAttachment;

use Modules\Applicant\App\Http\Resources\ApplicantAttachment\ApplicantAttachmentResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantAttachment\ApplicantAttachmentRepository;

class ApplicantAttachmentServiceImplement extends ServiceApi implements ApplicantAttachmentService
{
    ...
    public function __construct(ApplicantAttachmentRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantAttachmentResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantAttachmentResource($response));
    }
