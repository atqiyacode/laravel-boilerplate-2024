...
namespace Modules\Applicant\App\Services\ApplicantRelationReference;

use Modules\Applicant\App\Http\Resources\ApplicantRelationReference\ApplicantRelationReferenceResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantRelationReference\ApplicantRelationReferenceRepository;

class ApplicantRelationReferenceServiceImplement extends ServiceApi implements ApplicantRelationReferenceService
{
    ...
    public function __construct(ApplicantRelationReferenceRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantRelationReferenceResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantRelationReferenceResource($response));
    }
