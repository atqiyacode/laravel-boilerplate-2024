...
namespace Modules\Applicant\App\Services\ApplicantContact;

use Modules\Applicant\App\Http\Resources\ApplicantContact\ApplicantContactResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantContact\ApplicantContactRepository;

class ApplicantContactServiceImplement extends ServiceApi implements ApplicantContactService
{
    ...
    public function __construct(ApplicantContactRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantContactResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantContactResource($response));
    }
