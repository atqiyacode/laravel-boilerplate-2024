...
namespace Modules\Applicant\App\Services\ApplicantOrganizationExperience;

use Modules\Applicant\App\Http\Resources\ApplicantOrganizationExperience\ApplicantOrganizationExperienceResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantOrganizationExperience\ApplicantOrganizationExperienceRepository;

class ApplicantOrganizationExperienceServiceImplement extends ServiceApi implements ApplicantOrganizationExperienceService
{
    ...
    public function __construct(ApplicantOrganizationExperienceRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantOrganizationExperienceResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantOrganizationExperienceResource($response));
    }
