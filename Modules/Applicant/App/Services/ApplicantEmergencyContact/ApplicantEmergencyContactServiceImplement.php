...
namespace Modules\Applicant\App\Services\ApplicantEmergencyContact;

use Modules\Applicant\App\Http\Resources\ApplicantEmergencyContact\ApplicantEmergencyContactResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantEmergencyContact\ApplicantEmergencyContactRepository;

class ApplicantEmergencyContactServiceImplement extends ServiceApi implements ApplicantEmergencyContactService
{
    ...
    public function __construct(ApplicantEmergencyContactRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantEmergencyContactResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantEmergencyContactResource($response));
    }
