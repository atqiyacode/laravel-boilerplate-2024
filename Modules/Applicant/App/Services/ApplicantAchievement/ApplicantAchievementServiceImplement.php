...
use Modules\Applicant\App\Http\Resources\ApplicantAchievement\ApplicantAchievementResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantAchievement\ApplicantAchievementRepository;

class ApplicantAchievementServiceImplement extends ServiceApi implements ApplicantAchievementService
{
    ...
    public function __construct(ApplicantAchievementRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantAchievementResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantAchievementResource($response));
    }
