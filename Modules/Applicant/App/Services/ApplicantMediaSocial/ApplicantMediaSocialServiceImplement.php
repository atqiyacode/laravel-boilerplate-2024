...
use Modules\Applicant\App\Http\Resources\ApplicantMediaSocial\ApplicantMediaSocialResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantMediaSocial\ApplicantMediaSocialRepository;

class ApplicantMediaSocialServiceImplement extends ServiceApi implements ApplicantMediaSocialService
{
    ...
    public function __construct(ApplicantMediaSocialRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantMediaSocialResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantMediaSocialResource($response));
    }
