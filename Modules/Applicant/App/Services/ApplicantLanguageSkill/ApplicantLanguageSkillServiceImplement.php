...
namespace Modules\Applicant\App\Services\ApplicantLanguageSkill;

use Modules\Applicant\App\Http\Resources\ApplicantLanguageSkill\ApplicantLanguageSkillResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantLanguageSkill\ApplicantLanguageSkillRepository;

class ApplicantLanguageSkillServiceImplement extends ServiceApi implements ApplicantLanguageSkillService
{
    ...
    public function __construct(ApplicantLanguageSkillRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantLanguageSkillResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantLanguageSkillResource($response));
    }
