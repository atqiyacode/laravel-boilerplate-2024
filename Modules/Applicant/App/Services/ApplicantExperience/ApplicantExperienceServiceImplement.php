...
use Modules\Applicant\App\Http\Resources\ApplicantExperience\ApplicantExperienceResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Applicant\App\Repositories\ApplicantExperience\ApplicantExperienceRepository;

class ApplicantExperienceServiceImplement extends ServiceApi implements ApplicantExperienceService
{
    ...
    public function __construct(ApplicantExperienceRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ApplicantExperienceResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ApplicantExperienceResource($response));
    }
