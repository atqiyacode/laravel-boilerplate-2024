...
use Modules\Applicant\App\Http\Requests\ApplicantExperience\CreateApplicantExperienceRequest;
use Modules\Applicant\App\Http\Requests\ApplicantExperience\UpdateApplicantExperienceRequest;
use Modules\Applicant\App\Services\ApplicantExperience\ApplicantExperienceService;
use Illuminate\Http\Request;

class PersonalApplicantExperienceController extends Controller
{
    protected $service;

    public function __construct(ApplicantExperienceService $service)
    {
     ...
     */
    public function store(CreateApplicantExperienceRequest $request)
    {
     ...
     */
    public function update(UpdateApplicantExperienceRequest $request, $id)
    {
