...
class PersonalApplicantContactController extends Controller
{
    protected $service;

    public function __construct(ApplicantContactService $service)
    {
     ...
     */
    public function store(CreateApplicantContactRequest $request)
    {
     ...
     */
    public function update(UpdateApplicantContactRequest $request, $id)
    {
        request()->merge([
            'applicant_resume_id' => auth()->user()->applicantResume->id
        ]);
