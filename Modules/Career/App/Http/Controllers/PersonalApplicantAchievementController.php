...
use Modules\Applicant\App\Http\Requests\ApplicantAchievement\CreateApplicantAchievementRequest;
use Modules\Applicant\App\Http\Requests\ApplicantAchievement\UpdateApplicantAchievementRequest;
use Modules\Applicant\App\Services\ApplicantAchievement\ApplicantAchievementService;
use Illuminate\Http\Request;

class PersonalApplicantAchievementController extends Controller
{
    protected $service;

    public function __construct(ApplicantAchievementService $service)
    {
     ...
     */
    public function store(CreateApplicantAchievementRequest $request)
    {
     ...
     */
    public function update(UpdateApplicantAchievementRequest $request, $id)
    {
