...
use Modules\Applicant\App\Http\Requests\ApplicantAttachment\CreateApplicantAttachmentRequest;
use Modules\Applicant\App\Http\Requests\ApplicantAttachment\UpdateApplicantAttachmentRequest;
use Modules\Applicant\App\Services\ApplicantAttachment\ApplicantAttachmentService;
use Illuminate\Http\Request;

class PersonalApplicantAttachmentController extends Controller
{
    protected $service;

    public function __construct(ApplicantAttachmentService $service)
    {
     ...
     */
    public function store(CreateApplicantAttachmentRequest $request)
    {
     ...
     */
    public function update(UpdateApplicantAttachmentRequest $request, $id)
    {
