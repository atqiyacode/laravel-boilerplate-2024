...
class PersonalApplicantMediaSocialController extends Controller
{
    protected $service;

    public function __construct(ApplicantMediaSocialService $service)
    {
     ...
     */
    public function store(CreateApplicantMediaSocialRequest $request)
    {
     ...
     */
    public function update(UpdateApplicantMediaSocialRequest $request, $id)
    {
