...
class CareerServiceProvider extends ServiceProvider
{
    ...
    private function autoBindServices(): void
    {
        ...
        foreach ($modelFiles as $modelFile) {
            ...
            // Define the namespace for service interfaces
            $serviceNamespace = 'Modules\\' . $this->moduleName . '\\Modules\Applicant\App\Services\\' . $className . '\\';

            // Define the namespace for service implementations
            $implementationNamespace = 'Modules\\' . $this->moduleName . '\\Modules\Applicant\App\Services\\' . $className . '\\';
