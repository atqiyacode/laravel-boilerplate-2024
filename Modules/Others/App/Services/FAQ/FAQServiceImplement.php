...
use Modules\Others\App\Http\Resources\FAQ\FAQResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Others\App\Repositories\FAQ\FAQRepository;
...
class FAQServiceImplement extends ServiceApi implements FAQService
{
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(FAQResource::collection($response));
    }
    ...
    {
        $response = $this->mainRepository->getAllPublic();
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(FAQResource::collection($response));
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new FAQResource($response));
    }
