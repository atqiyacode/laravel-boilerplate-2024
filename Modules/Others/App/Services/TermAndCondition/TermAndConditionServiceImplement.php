...
use Modules\Others\App\Repositories\TermAndCondition\TermAndConditionRepository;

class TermAndConditionServiceImplement extends ServiceApi implements TermAndConditionService
{
    ...
    public function __construct(TermAndConditionRepository $mainRepository)
    {
    ...
    public function findFirst()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new TermAndConditionResource($response));
    }
