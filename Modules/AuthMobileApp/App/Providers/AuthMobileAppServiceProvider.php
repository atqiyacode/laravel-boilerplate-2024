...
namespace Modules\AuthMobileApp\App\Providers;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;

class AuthMobileAppServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'AuthMobileApp';

    protected string $moduleNameLower = 'authmobileapp';
