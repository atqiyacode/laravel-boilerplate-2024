...
use Modules\JobApplication\App\Http\Requests\JobApplicationStatus\CreateJobApplicationStatusRequest;
use Modules\JobApplication\App\Http\Requests\JobApplicationStatus\UpdateJobApplicationStatusRequest;
use Modules\JobApplication\App\Services\JobApplicationStatus\JobApplicationStatusService;
...
class JobApplicationStatusController extends Controller
{
    ...
    public function __construct(JobApplicationStatusService $service)
    {
     ...
     */
    public function store(CreateJobApplicationStatusRequest $request)
    {
     ...
     */
    public function update(UpdateJobApplicationStatusRequest $request, $id)
    {
