...
namespace Modules\JobApplication\App\Repositories\JobApplication;
...
class JobApplicationRepositoryImplement extends Eloquent implements JobApplicationRepository
{
    ...
    public function getAll()
    {
        return $this->model->canDelete()
            ->with(['user', 'jobVacancy', 'applicantResume'])
            ->useFilters()->get();
    }
