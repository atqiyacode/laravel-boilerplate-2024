...
namespace Modules\JobApplication\App\Repositories\JobApplicationStatus;
...
class JobApplicationStatusRepositoryImplement extends Eloquent implements JobApplicationStatusRepository
{
    ...
    public function __construct(JobApplicationStatus $model)
    {
        $this->model = $model;
    }
