...
namespace Modules\JobApplication\App\Services\JobApplicationStatus;

use Modules\JobApplication\App\Http\Resources\JobApplicationStatus\JobApplicationStatusResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\JobApplication\App\Repositories\JobApplicationStatus\JobApplicationStatusRepository;

class JobApplicationStatusServiceImplement extends ServiceApi implements JobApplicationStatusService
{
    ...
    public function __construct(JobApplicationStatusRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(JobApplicationStatusResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new JobApplicationStatusResource($response));
    }
