...
use Modules\HRMaster\App\Http\Requests\MainClass\UpdateMainClassRequest;
use Modules\HRMaster\App\Services\MainClass\MainClassService;
...
class MainClassController extends Controller
{
    ...
    public function __construct(MainClassService $service)
    {
     ...
     */
    public function store(CreateMainClassRequest $request)
    {
     ...
     */
    public function update(UpdateMainClassRequest $request, $id)
    {
