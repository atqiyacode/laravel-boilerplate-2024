...
use Modules\HRMaster\App\Exports\WorkingAreaExport;
use App\Http\Controllers\Controller;
use Modules\HRMaster\App\Http\Requests\WorkingArea\CreateWorkingAreaRequest;
use Modules\HRMaster\App\Http\Requests\WorkingArea\UpdateWorkingAreaRequest;
use Modules\HRMaster\App\Services\WorkingArea\WorkingAreaService;
...
class WorkingAreaController extends Controller
{
    ...
    public function __construct(WorkingAreaService $service)
    {
     ...
     */
    public function store(CreateWorkingAreaRequest $request)
    {
     ...
     */
    public function update(UpdateWorkingAreaRequest $request, $id)
    {
