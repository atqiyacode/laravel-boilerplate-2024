...
use Modules\HRMaster\App\Http\Requests\TypeOfPermit\CreateTypeOfPermitRequest;
use Modules\HRMaster\App\Http\Requests\TypeOfPermit\UpdateTypeOfPermitRequest;
use Modules\HRMaster\App\Services\TypeOfPermit\TypeOfPermitService;
use Illuminate\Http\Request;

class TypeOfPermitController extends Controller
{
    protected $service;

    public function __construct(TypeOfPermitService $service)
    {
     ...
     */
    public function store(CreateTypeOfPermitRequest $request)
    {
     ...
     */
    public function update(UpdateTypeOfPermitRequest $request, $id)
    {
