...
namespace Modules\HRMaster\App\Repositories\TypeOfPermit;
...
class TypeOfPermitRepositoryImplement extends Eloquent implements TypeOfPermitRepository
{
    ...
    public function __construct(TypeOfPermit $model)
    {
        $this->model = $model;
    }
