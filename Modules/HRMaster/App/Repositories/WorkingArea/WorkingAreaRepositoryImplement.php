...
namespace Modules\HRMaster\App\Repositories\WorkingArea;
...
class WorkingAreaRepositoryImplement extends Eloquent implements WorkingAreaRepository
{
    ...
    public function __construct(WorkingArea $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->withCount(['employees'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->withCount(['employees'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->withCount(['employees'])->useFilters()->findOrFail($id);
    }
