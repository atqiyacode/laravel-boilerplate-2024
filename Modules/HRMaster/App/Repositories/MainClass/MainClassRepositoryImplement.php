...
namespace Modules\HRMaster\App\Repositories\MainClass;
...
class MainClassRepositoryImplement extends Eloquent implements MainClassRepository
{
    ...
    public function __construct(MainClass $model)
    {
        $this->model = $model;
    }
