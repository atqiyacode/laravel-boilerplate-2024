...
namespace Modules\HRMaster\App\Services\MainClass;

use Modules\HRMaster\App\Http\Resources\MainClass\MainClassResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\HRMaster\App\Repositories\MainClass\MainClassRepository;

class MainClassServiceImplement extends ServiceApi implements MainClassService
{
    ...
    public function __construct(MainClassRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(MainClassResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new MainClassResource($response));
    }
