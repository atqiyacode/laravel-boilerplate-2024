...
namespace Modules\HRMaster\App\Services\FieldOfWork;

use Modules\HRMaster\App\Http\Resources\FieldOfWork\FieldOfWorkResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\HRMaster\App\Repositories\FieldOfWork\FieldOfWorkRepository;

class FieldOfWorkServiceImplement extends ServiceApi implements FieldOfWorkService
{
    ...
    public function __construct(FieldOfWorkRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(FieldOfWorkResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new FieldOfWorkResource($response));
    }
