...
namespace Modules\HRMaster\App\Services\WorkingArea;

use Modules\HRMaster\App\Http\Resources\WorkingArea\WorkingAreaResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\HRMaster\App\Repositories\WorkingArea\WorkingAreaRepository;

class WorkingAreaServiceImplement extends ServiceApi implements WorkingAreaService
{
    ...
    public function __construct(WorkingAreaRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(WorkingAreaResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new WorkingAreaResource($response));
    }
