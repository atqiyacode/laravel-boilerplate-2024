...
namespace Modules\HRMaster\App\Services\Unit;

use Modules\HRMaster\App\Http\Resources\Unit\UnitResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\HRMaster\App\Repositories\Unit\UnitRepository;

class UnitServiceImplement extends ServiceApi implements UnitService
{
    ...
    public function __construct(UnitRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(UnitResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new UnitResource($response));
    }
