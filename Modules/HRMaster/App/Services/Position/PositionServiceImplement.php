...
namespace Modules\HRMaster\App\Services\Position;

use Modules\HRMaster\App\Http\Resources\Position\PositionResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\HRMaster\App\Repositories\Position\PositionRepository;

class PositionServiceImplement extends ServiceApi implements PositionService
{
    ...
    public function __construct(PositionRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(PositionResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new PositionResource($response));
    }
