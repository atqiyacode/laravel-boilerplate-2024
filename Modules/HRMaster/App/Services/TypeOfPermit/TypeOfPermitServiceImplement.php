...
use Modules\HRMaster\App\Http\Resources\TypeOfPermit\TypeOfPermitResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\HRMaster\App\Repositories\TypeOfPermit\TypeOfPermitRepository;

class TypeOfPermitServiceImplement extends ServiceApi implements TypeOfPermitService
{
    ...
    public function __construct(TypeOfPermitRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(TypeOfPermitResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new TypeOfPermitResource($response));
    }
