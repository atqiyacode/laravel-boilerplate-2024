...
use Modules\DynamicForm\App\Http\Requests\ResponseData\UpdateResponseDataRequest;
use Modules\DynamicForm\App\Services\ResponseData\ResponseDataService;
...
class ResponseDataController extends Controller
{
    ...
    public function __construct(ResponseDataService $service)
    {
     ...
     */
    public function store(CreateResponseDataRequest $request)
    {
     ...
     */
    public function update(UpdateResponseDataRequest $request, $id)
    {
