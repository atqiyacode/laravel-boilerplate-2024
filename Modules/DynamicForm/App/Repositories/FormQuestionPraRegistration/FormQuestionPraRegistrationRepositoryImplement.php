...
namespace Modules\DynamicForm\App\Repositories\FormQuestionPraRegistration;
...
class FormQuestionPraRegistrationRepositoryImplement extends Eloquent implements FormQuestionPraRegistrationRepository
{
    ...
    public function __construct(FormQuestionPraRegistration $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->useFilters()->findOrFail($id);
    }
