...
namespace Modules\DynamicForm\App\Repositories\Response;
...
class ResponseRepositoryImplement extends Eloquent implements ResponseRepository
{
    ...
    {
        return $this->model->withCount(['responseData'])->with([
            'form',
            'applicantResume',
