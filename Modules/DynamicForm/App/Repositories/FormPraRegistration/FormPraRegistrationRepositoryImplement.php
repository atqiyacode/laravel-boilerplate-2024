...
namespace Modules\DynamicForm\App\Repositories\FormPraRegistration;
...
class FormPraRegistrationRepositoryImplement extends Eloquent implements FormPraRegistrationRepository
{
    ...
    public function __construct(FormPraRegistration $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->with(['applicantResume', 'project', 'formQuestionPraRegistration'])->canDelete()->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->with(['applicantResume', 'project', 'formQuestionPraRegistration'])->canDelete()->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->with(['applicantResume', 'project', 'formQuestionPraRegistration'])->canDelete()->useFilters()->findOrFail($id);
    }
