...
namespace Modules\DynamicForm\App\Repositories\ResponseData;
...
class ResponseDataRepositoryImplement extends Eloquent implements ResponseDataRepository
{
    ...
    public function __construct(ResponseData $model)
    {
        $this->model = $model;
    }
