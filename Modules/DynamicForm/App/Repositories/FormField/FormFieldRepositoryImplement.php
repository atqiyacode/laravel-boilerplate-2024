...
namespace Modules\DynamicForm\App\Repositories\FormField;
...
class FormFieldRepositoryImplement extends Eloquent implements FormFieldRepository
{
    ...
    public function getAll()
    {
        return $this->model->withCount([
            'responseDatas',
            'options'
        ])->with(['form'])->canDelete()->useFilters()->get();
    }
    ...
    public function getPaginate()
    {
        return $this->model->withCount([
            'responseDatas',
            'options'
        ])->with(['form'])->canDelete()->useFilters()->dynamicPaginate();
    }
