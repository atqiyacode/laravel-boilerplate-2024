...
namespace Modules\DynamicForm\App\Services\Form;

use Modules\DynamicForm\App\Http\Resources\Form\FormResource;
use Modules\DynamicForm\App\Http\Resources\Form\SimpleFormResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\DynamicForm\App\Repositories\Form\FormRepository;

class FormServiceImplement extends ServiceApi implements FormService
{
    ...
    public function __construct(FormRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(SimpleFormResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new FormResource($response));
    }
