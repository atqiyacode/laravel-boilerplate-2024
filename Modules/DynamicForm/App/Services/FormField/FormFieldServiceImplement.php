...
use Modules\DynamicForm\App\Http\Resources\FormField\FormFieldResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\DynamicForm\App\Repositories\FormField\FormFieldRepository;

class FormFieldServiceImplement extends ServiceApi implements FormFieldService
{
    ...
    public function __construct(FormFieldRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(FormFieldResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new FormFieldResource($response));
    }
