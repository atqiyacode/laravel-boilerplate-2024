...
namespace Modules\DynamicForm\App\Services\FormPraRegistration;

use Modules\DynamicForm\App\Http\Resources\FormPraRegistration\FormPraRegistrationResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\DynamicForm\App\Repositories\FormPraRegistration\FormPraRegistrationRepository;

class FormPraRegistrationServiceImplement extends ServiceApi implements FormPraRegistrationService
{
    ...
    public function __construct(FormPraRegistrationRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(FormPraRegistrationResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new FormPraRegistrationResource($response));
    }
