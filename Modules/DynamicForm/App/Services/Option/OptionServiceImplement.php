...
namespace Modules\DynamicForm\App\Services\Option;

use Modules\DynamicForm\App\Http\Resources\Option\OptionResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\DynamicForm\App\Repositories\Option\OptionRepository;

class OptionServiceImplement extends ServiceApi implements OptionService
{
    ...
    public function __construct(OptionRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(OptionResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new OptionResource($response));
    }
