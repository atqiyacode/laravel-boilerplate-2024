...
namespace Modules\DynamicForm\App\Services\ResponseData;

use Modules\DynamicForm\App\Http\Resources\ResponseData\ResponseDataResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\DynamicForm\App\Repositories\ResponseData\ResponseDataRepository;

class ResponseDataServiceImplement extends ServiceApi implements ResponseDataService
{
    ...
    public function __construct(ResponseDataRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ResponseDataResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ResponseDataResource($response));
    }
