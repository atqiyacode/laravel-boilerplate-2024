...
namespace Modules\DynamicForm\App\Services\Response;

use Modules\DynamicForm\App\Http\Resources\Response\ResponseResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\DynamicForm\App\Repositories\Response\ResponseRepository;
...
class ResponseServiceImplement extends ServiceApi implements ResponseService
{
    ...
    public function __construct(ResponseRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ResponseResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ResponseResource($response));
    }
