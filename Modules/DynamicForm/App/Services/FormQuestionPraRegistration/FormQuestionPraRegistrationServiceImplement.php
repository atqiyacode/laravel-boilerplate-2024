...
namespace Modules\DynamicForm\App\Services\FormQuestionPraRegistration;

use Modules\DynamicForm\App\Http\Resources\FormQuestionPraRegistration\FormQuestionPraRegistrationResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\DynamicForm\App\Repositories\FormQuestionPraRegistration\FormQuestionPraRegistrationRepository;

class FormQuestionPraRegistrationServiceImplement extends ServiceApi implements FormQuestionPraRegistrationService
{
    ...
    public function __construct(FormQuestionPraRegistrationRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(FormQuestionPraRegistrationResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new FormQuestionPraRegistrationResource($response));
    }
