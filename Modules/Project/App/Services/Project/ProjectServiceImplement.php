...
use Modules\Project\App\Http\Resources\Project\ProjectResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Project\App\Repositories\Project\ProjectRepository;

class ProjectServiceImplement extends ServiceApi implements ProjectService
{
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(ProjectResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new ProjectResource($response));
    }
