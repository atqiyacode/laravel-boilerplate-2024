...
namespace Modules\Notification\App\Repositories\TemplateNotification;
...
class TemplateNotificationRepositoryImplement extends Eloquent implements TemplateNotificationRepository
{
    ...
    {
        return $this->model->canDelete()->with(['notificationType'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['notificationType'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->with(['notificationType'])->useFilters()->findOrFail($id);
    }
