...
namespace Modules\Notification\App\Services\NotificationType;

use Modules\Notification\App\Http\Resources\NotificationType\NotificationTypeResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Notification\App\Repositories\NotificationType\NotificationTypeRepository;

class NotificationTypeServiceImplement extends ServiceApi implements NotificationTypeService
{
    ...
    public function __construct(NotificationTypeRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(NotificationTypeResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new NotificationTypeResource($response));
    }
