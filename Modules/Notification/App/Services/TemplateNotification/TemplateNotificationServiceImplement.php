...
namespace Modules\Notification\App\Services\TemplateNotification;

use Modules\Notification\App\Http\Resources\TemplateNotification\TemplateNotificationResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\Notification\App\Repositories\TemplateNotification\TemplateNotificationRepository;

class TemplateNotificationServiceImplement extends ServiceApi implements TemplateNotificationService
{
    ...
    public function __construct(TemplateNotificationRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(TemplateNotificationResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new TemplateNotificationResource($response));
    }
