...
class RecruitmentStepController extends Controller
{
    ...
    public function __construct(RecruitmentStepService $service)
    {
     ...
     */
    public function store(CreateRecruitmentStepRequest $request)
    {
     ...
     */
    public function update(UpdateRecruitmentStepRequest $request, $id)
    {
