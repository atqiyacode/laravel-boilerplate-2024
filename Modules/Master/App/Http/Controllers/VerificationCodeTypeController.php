...
class VerificationCodeTypeController extends Controller
{
    ...
    public function __construct(VerificationCodeTypeService $service)
    {
     ...
     */
    public function store(CreateVerificationCodeTypeRequest $request)
    {
     ...
     */
    public function update(UpdateVerificationCodeTypeRequest $request, $id)
    {
