...
class LevelOfEducationRepositoryImplement extends Eloquent implements LevelOfEducationRepository
{
    ...
    public function __construct(LevelOfEducation $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->withCount(['employees', 'applicants'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->withCount(['employees', 'applicants'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->withCount(['employees', 'applicants'])->useFilters()->findOrFail($id);
    }
