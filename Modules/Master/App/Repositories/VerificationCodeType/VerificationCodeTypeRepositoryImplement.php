...
namespace Modules\Master\App\Repositories\VerificationCodeType;
...
class VerificationCodeTypeRepositoryImplement extends Eloquent implements VerificationCodeTypeRepository
{
    ...
    public function __construct(VerificationCodeType $model)
    {
        $this->model = $model;
    }
