...
namespace App\Repositories\RecruitmentStep;
...
class RecruitmentStepRepositoryImplement extends Eloquent implements RecruitmentStepRepository
{
    ...
    public function __construct(RecruitmentStep $model)
    {
        $this->model = $model;
    }
