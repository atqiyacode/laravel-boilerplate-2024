...
class RecruitmentStepServiceImplement extends ServiceApi implements RecruitmentStepService
{
    ...
    public function __construct(RecruitmentStepRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(RecruitmentStepResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new RecruitmentStepResource($response));
    }
