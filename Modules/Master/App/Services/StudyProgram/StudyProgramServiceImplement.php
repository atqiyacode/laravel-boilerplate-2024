...
class StudyProgramServiceImplement extends ServiceApi implements StudyProgramService
{
    ...
    public function __construct(StudyProgramRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(StudyProgramResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new StudyProgramResource($response));
    }
    ...
    public function getFromPDDIKTI()
    {
        $response = DB::transaction(function () {
            return $this->mainRepository->getFromPDDIKTI();
        });
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
