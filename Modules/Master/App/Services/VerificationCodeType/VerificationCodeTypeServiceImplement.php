...
class VerificationCodeTypeServiceImplement extends ServiceApi implements VerificationCodeTypeService
{
    ...
    public function __construct(VerificationCodeTypeRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(VerificationCodeTypeResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new VerificationCodeTypeResource($response));
    }
