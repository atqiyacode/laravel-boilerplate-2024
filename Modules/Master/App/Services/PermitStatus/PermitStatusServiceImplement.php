...
class PermitStatusServiceImplement extends ServiceApi implements PermitStatusService
{
    ...
    public function __construct(PermitStatusRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(PermitStatusResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new PermitStatusResource($response));
    }
