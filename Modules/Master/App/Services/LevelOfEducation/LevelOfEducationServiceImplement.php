...
class LevelOfEducationServiceImplement extends ServiceApi implements LevelOfEducationService
{
    ...
    public function __construct(LevelOfEducationRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(LevelOfEducationResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new LevelOfEducationResource($response));
    }
