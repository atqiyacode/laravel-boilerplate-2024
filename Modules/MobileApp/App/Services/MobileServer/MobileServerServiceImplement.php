...
namespace Modules\MobileApp\App\Services\MobileServer;

use Modules\MobileApp\App\Http\Resources\MobileServer\MobileServerResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\MobileApp\App\Repositories\MobileServer\MobileServerRepository;

class MobileServerServiceImplement extends ServiceApi implements MobileServerService
{
    ...
    public function __construct(MobileServerRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(MobileServerResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new MobileServerResource($response));
    }
