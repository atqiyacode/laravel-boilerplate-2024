...
namespace Modules\MobileApp\App\Services\MobileNews;

use Modules\MobileApp\App\Http\Resources\MobileNews\MobileNewsResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\MobileApp\App\Repositories\MobileNews\MobileNewsRepository;

class MobileNewsServiceImplement extends ServiceApi implements MobileNewsService
{
    ...
    public function __construct(MobileNewsRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(MobileNewsResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new MobileNewsResource($response));
    }
