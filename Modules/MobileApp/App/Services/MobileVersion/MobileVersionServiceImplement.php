...
namespace Modules\MobileApp\App\Services\MobileVersion;

use Modules\MobileApp\App\Http\Resources\MobileVersion\MobileVersionResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\MobileApp\App\Repositories\MobileVersion\MobileVersionRepository;

class MobileVersionServiceImplement extends ServiceApi implements MobileVersionService
{
    ...
    public function __construct(MobileVersionRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(MobileVersionResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new MobileVersionResource($response));
    }
