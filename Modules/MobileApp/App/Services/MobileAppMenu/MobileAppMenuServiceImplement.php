...
namespace Modules\MobileApp\App\Services\MobileAppMenu;

use Modules\MobileApp\App\Http\Resources\MobileAppMenu\MobileAppMenuResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\MobileApp\App\Repositories\MobileAppMenu\MobileAppMenuRepository;

class MobileAppMenuServiceImplement extends ServiceApi implements MobileAppMenuService
{
    ...
    public function __construct(MobileAppMenuRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(MobileAppMenuResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new MobileAppMenuResource($response));
    }
