...
use Modules\MobileApp\App\Services\MobileAppMenu\MobileAppMenuService;
...
class MobileAppMenuController extends Controller
{
    ...
    public function __construct(MobileAppMenuService $service)
    {
     ...
     */
    public function store(CreateMobileAppMenuRequest $request)
    {
     ...
     */
    public function update(UpdateMobileAppMenuRequest $request, $id)
    {
