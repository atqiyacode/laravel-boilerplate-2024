...
use Modules\MobileApp\App\Services\MobileNews\MobileNewsService;
...
class MobileNewsController extends Controller
{
    ...
    public function __construct(MobileNewsService $service)
    {
     ...
     */
    public function store(CreateMobileNewsRequest $request)
    {
     ...
     */
    public function update(UpdateMobileNewsRequest $request, $id)
    {
