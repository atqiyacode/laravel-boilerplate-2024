...
namespace Modules\MobileApp\App\Repositories\MobileServer;
...
class MobileServerRepositoryImplement extends Eloquent implements MobileServerRepository
{
    ...
    public function __construct(MobileServer $model)
    {
        $this->model = $model;
    }
