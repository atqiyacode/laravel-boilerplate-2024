...
namespace Modules\MobileApp\App\Repositories\MobileVersion;
...
class MobileVersionRepositoryImplement extends Eloquent implements MobileVersionRepository
{
    ...
    public function __construct(MobileVersion $model)
    {
        $this->model = $model;
    }
