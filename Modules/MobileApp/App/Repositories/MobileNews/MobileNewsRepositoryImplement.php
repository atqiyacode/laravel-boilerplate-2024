...
namespace Modules\MobileApp\App\Repositories\MobileNews;
...
class MobileNewsRepositoryImplement extends Eloquent implements MobileNewsRepository
{
    ...
    public function __construct(MobileNews $model)
    {
        $this->model = $model;
    }
