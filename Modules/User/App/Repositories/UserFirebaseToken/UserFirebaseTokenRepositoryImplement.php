...
namespace Modules\User\App\Repositories\UserFirebaseToken;
...
class UserFirebaseTokenRepositoryImplement extends Eloquent implements UserFirebaseTokenRepository
{
    ...
    public function __construct(UserFirebaseToken $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->with(['user'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->with(['user'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->with(['user'])->useFilters()->findOrFail($id);
    }
