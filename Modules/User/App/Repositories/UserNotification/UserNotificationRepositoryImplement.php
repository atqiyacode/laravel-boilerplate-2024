...
namespace Modules\User\App\Repositories\UserNotification;
...
class UserNotificationRepositoryImplement extends Eloquent implements UserNotificationRepository
{
    ...
    {
        return $this->model->canDelete()->with(['templateNotification', 'user'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['templateNotification', 'user'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->with(['templateNotification', 'user'])->useFilters()->findOrFail($id);
    }
