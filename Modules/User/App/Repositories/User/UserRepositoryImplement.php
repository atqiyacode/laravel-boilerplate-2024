...
use Modules\User\App\Models\UserLogActivity;
...
class UserRepositoryImplement extends Eloquent implements UserRepository
{
    ...
    public function create($data)
    {
        ...
        $query->assignRole($data['roles']);
        $query->givePermissionTo($data['permissions']);
        return $query;
    }
    ...
    {
        return UserLogActivity::where('user_id', $userId)
