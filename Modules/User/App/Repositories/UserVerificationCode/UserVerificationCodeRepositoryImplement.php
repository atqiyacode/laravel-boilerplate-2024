...
namespace Modules\User\App\Repositories\UserVerificationCode;
...
class UserVerificationCodeRepositoryImplement extends Eloquent implements UserVerificationCodeRepository
{
    ...
    public function __construct(UserVerificationCode $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->with(['user', 'verificationCodeType'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['user', 'verificationCodeType'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->with(['user', 'verificationCodeType'])->useFilters()->findOrFail($id);
    }
