...
namespace Modules\User\App\Services\UserFirebaseToken;

use Modules\User\App\Http\Resources\UserFirebaseToken\UserFirebaseTokenResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\User\App\Repositories\UserFirebaseToken\UserFirebaseTokenRepository;

class UserFirebaseTokenServiceImplement extends ServiceApi implements UserFirebaseTokenService
{
    ...
    public function __construct(UserFirebaseTokenRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(UserFirebaseTokenResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new UserFirebaseTokenResource($response));
    }
