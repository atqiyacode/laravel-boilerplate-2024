...
namespace Modules\User\App\Services\UserNotification;

use Modules\User\App\Http\Resources\UserNotification\MobileUserNotificationResource;
use Modules\User\App\Http\Resources\UserNotification\UserNotificationResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\User\App\Repositories\UserNotification\UserNotificationRepository;

class UserNotificationServiceImplement extends ServiceApi implements UserNotificationService
{
    ...
    public function __construct(UserNotificationRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(UserNotificationResource::collection($response));
    }
    ...
    public function getPaginateMobile()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(MobileUserNotificationResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new UserNotificationResource($response));
    }

    public function findByIdMobile($id)
    {
        $response = $this->mainRepository->findByIdMobile($id);
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new MobileUserNotificationResource($response));
    }
