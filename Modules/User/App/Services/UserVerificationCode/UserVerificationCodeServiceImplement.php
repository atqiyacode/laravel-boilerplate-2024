...
namespace Modules\User\App\Services\UserVerificationCode;

use Modules\User\App\Http\Resources\UserVerificationCode\UserVerificationCodeResource;
use LaravelEasyRepository\ServiceApi;
use Illuminate\Support\Facades\DB;
use Modules\User\App\Repositories\UserVerificationCode\UserVerificationCodeRepository;

class UserVerificationCodeServiceImplement extends ServiceApi implements UserVerificationCodeService
{
    ...
    public function __construct(UserVerificationCodeRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(UserVerificationCodeResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new UserVerificationCodeResource($response));
    }
