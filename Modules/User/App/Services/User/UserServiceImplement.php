...
use Modules\User\App\Http\Resources\User\UserResource;
use Modules\User\App\Http\Resources\UserLogActivity\MobileLoginHistoryResource;
...
class UserServiceImplement extends ServiceApi implements UserService
{
    ...
    {
        $response = $this->mainRepository->loginHistory($userId);
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(MobileLoginHistoryResource::collection($response));
    }
}
