...
class MobileMediaSocialController extends Controller
{
    protected $service;

    public function __construct(EmployeeMediaSocialService $service)
    {
     ...
     */
    public function store(CreateEmployeeMediaSocialRequest $request)
    {
        $request->merge([
            'employee_id' => auth()->user()->employee->id
        ]);
     ...
     */
    public function update(UpdateEmployeeMediaSocialRequest $request, $id)
    {
