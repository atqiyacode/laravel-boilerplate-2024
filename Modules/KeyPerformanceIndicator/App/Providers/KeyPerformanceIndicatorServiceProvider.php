...
namespace Modules\KeyPerformanceIndicator\App\Providers;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;

class KeyPerformanceIndicatorServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'KeyPerformanceIndicator';

    protected string $moduleNameLower = 'keyperformanceindicator';
