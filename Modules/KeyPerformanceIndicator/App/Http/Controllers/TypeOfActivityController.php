...
class TypeOfActivityController extends Controller
{
    ...
    public function __construct(TypeOfActivityService $service)
    {
     ...
     */
    public function store(CreateTypeOfActivityRequest $request)
    {
     ...
     */
    public function update(UpdateTypeOfActivityRequest $request, $id)
    {
