...
class PerformanceAssessmentController extends Controller
{
    ...
    public function __construct(PerformanceAssessmentService $service)
    {
     ...
     */
    public function store(CreatePerformanceAssessmentRequest $request)
    {
     ...
     */
    public function update(UpdatePerformanceAssessmentRequest $request, $id)
    {
