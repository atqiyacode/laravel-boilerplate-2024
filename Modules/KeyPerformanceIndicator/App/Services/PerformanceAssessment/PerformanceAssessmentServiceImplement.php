...
class PerformanceAssessmentServiceImplement extends ServiceApi implements PerformanceAssessmentService
{
    ...
    public function __construct(PerformanceAssessmentRepository $mainRepository)
    {
    ...
    public function getPaginate()
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(PerformanceAssessmentResource::collection($response));
    }
    ...
    public function findById($id)
    {
        ...
        return $this->setMessage(__('alert.success-found'))
            ->setStatus(true)
            ->setCode(200)
            ->setResult(new PerformanceAssessmentResource($response));
    }
