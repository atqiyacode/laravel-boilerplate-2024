...
class TypeOfActivityRepositoryImplement extends Eloquent implements TypeOfActivityRepository
{
    ...
    public function __construct(TypeOfActivity $model)
    {
        $this->model = $model;
    }
    ...
    {
        return $this->model->canDelete()->with(['fieldOfWork'])->useFilters()->get();
    }

    public function getPaginate()
    {
        return $this->model->canDelete()->with(['fieldOfWork'])->useFilters()->dynamicPaginate();
    }

    public function findById($id)
    {
        return $this->model->canDelete()->with(['fieldOfWork'])->useFilters()->findOrFail($id);
    }
