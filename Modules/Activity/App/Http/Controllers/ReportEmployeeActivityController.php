...
use Modules\Employee\App\Http\Requests\EmployeeActivity\UpdateEmployeeActivityRequest;
use Modules\Employee\App\Services\EmployeeActivity\EmployeeActivityService;

class ReportEmployeeActivityController extends Controller
{
    protected $service;

    public function __construct(EmployeeActivityService $service)
    {
    ...
    {
        return $this->service->getPaginateByEmployeeId($id)->toJson();
    }
